                                    ...
                                    <table id="u_content_heading_2" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 0px;font-family:'Open Sans',sans-serif;" align="left">
                                                ...
                                                <h1 class="v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Arvo; font-size: 22px; font-weight: 400;"><strong></strong><br /><strong>Phản Hồi Khách Hàng</strong></h1>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 30px;font-family:'Open Sans',sans-serif;" align="left">
                                                ...
                                                <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 180%; text-align: justify; word-wrap: break-word;">
                                                    <p style="line-height: 180%; font-size: 14px;">Xin chào khách hàng <b>{{ $name }}</b>, đây là mail tự động của hệ thống Tìm Việc Kiên Giang gửi phản hồi sau khi nhận được mail của khách hàng</p>
                                                    <p style="line-height: 180%; font-size: 14px;"> </p>
                                                    <p style="line-height: 180%; font-size: 14px; text-align: center;"><strong>Thông tin khách hàng</strong></p>
                                                    ...
                                                    <p style="line-height: 180%; font-size: 14px;"> </p>
                                                    <p style="line-height: 180%; font-size: 14px; text-align: center;"><strong>Chúng tôi xin phản hồi như sau:</strong></p>
                                                    <p style="line-height: 180%; font-size: 14px;"> </p>
                                                    <p style="line-height: 180%; font-size: 14px;">
                                                    {!!$content!!}
                                                    </p>
