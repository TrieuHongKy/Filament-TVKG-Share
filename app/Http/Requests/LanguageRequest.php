...
class LanguageRequest extends FormRequest
{
    ...
    {
        return [
            'name'        => 'required|string|regex:/^[a-zA-ZÀ-Ỹà-ỹ\s]*$/|max:255|unique:languages,name',
            'slug'        => 'required',
        ];
    }
    ...
    {
        return [
            'name'        => 'required|string|regex:/^[a-zA-ZÀ-Ỹà-ỹ\s]*$/|max:255|unique:languages,name,' . $this->id,
            'slug'        => 'required',
        ];
    }
